...
/**
 * @author kismanhong
 * class for setting conditional style attribute
 */
public class ConditionalStyleInfo {
	private BodyStyleInfo style;
	...
	public ConditionalStyleInfo(ColorMode mode, String foreColor,
			String backColor, String pen, String fill, String radius,
			ScaleImageType scaleImage, HorizontalAlignment hAlign,
			VerticalAlignment vAlign, String border, String borderColor,
			int padding, String topBorder, String topBorderColor,
			int topPadding, String leftBorder, String leftBorderColor,
			int leftPadding, String bottomBorder, String bottomBorderColor,
			int bottomPadding, String rightBorder, String rightBorderColor,
			int rightPadding, Rotation rotation, LineSpace lineSpace,
			boolean isStyledText, FontType fontName, int fontSize,
			boolean isBold, boolean isUnderline, boolean isItalic,
			boolean isStrikeThrough, FontType pdfFontName, String pdfEncoding,
			boolean isPdfEmbedded, String pattern, boolean isBlankWhenNull,
			String conditionalExpression, double topLineWidth,
			double leftLineWidth, double bottomLineWidth,
			double rightLineWidth, String topLineColor, String leftLineColor,
			String bottomLineColor, String rightLineColor, boolean isDefault) {
		super();
		this.mode = mode;
	...
	public BodyStyleInfo getStyle() {
		return style;
	}
	public void setStyle(BodyStyleInfo style) {
		this.style = style;
	}
	...
	public double getTopLineWidth() {
		return topLineWidth;
	}
	public void setTopLineWidth(double topLineWidth) {
		this.topLineWidth = topLineWidth;
	}
	public double getLeftLineWidth() {
		return leftLineWidth;
	}
	public void setLeftLineWidth(double leftLineWidth) {
		this.leftLineWidth = leftLineWidth;
	}
	public double getBottomLineWidth() {
		return bottomLineWidth;
	}
	public void setBottomLineWidth(double bottomLineWidth) {
		this.bottomLineWidth = bottomLineWidth;
	}
	public double getRightLineWidth() {
		return rightLineWidth;
	}
	public void setRightLineWidth(double rightLineWidth) {
		this.rightLineWidth = rightLineWidth;
	}
	...
	public void setLeftLineColor(String leftLineColor) {
		this.leftLineColor = leftLineColor;
	}
	...
	public void setRightLineColor(String rightLineColor) {
		this.rightLineColor = rightLineColor;
	}
